...
public class ContactModificationTests extends TestBase {
  ...
  public void testContactModification() {
    ...
    ContactData contact = new ContactData()
            .withId(modifiedContact.getId()) /*задаем старый идентификатор*/.withFirstname("Андрей2").withLastname("Сулимов2").withAddress("Злынка2").withHomePhone("89001234562").withEmail("test2@mail.ru").withGroup(null);
