...
public class ContactDataGenerator {
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      jCommander.usage(); // выводим на консоль информацию о доступных опциях в случае возникновения исключения
      return;
    }
    generator.run();
  }
  ...
  private List<ContactData> generateContacts(int count) {
    List<ContactData> contacts = new ArrayList<ContactData>(); // создаем новый список объектов типа ContactData
